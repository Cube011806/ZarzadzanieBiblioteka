...
{
    /// <summary>
    /// Controller for managing email sending.
    /// Provides functionality for sending emails by using forms.
    /// </summary>
    public class ContactController : BaseController
    {
        ...
        /// <param name="message">Contains the body of the message</param>
